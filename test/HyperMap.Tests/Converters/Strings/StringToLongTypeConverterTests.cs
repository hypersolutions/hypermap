...
namespace HyperMap.Tests.Converters.Strings
{
    public class StringToLongTypeConverterTests
    {
        ...
        [InlineData(" ")]
        [InlineData("Hello")]
        public void StringToLongTypeConverter_WithInvalidString_Convert_ReturnsZero(string source)
        {
        ...
        [InlineData("1")]
        [InlineData("-1")]
        public void StringToLongTypeConverter_WithString_Convert_ReturnsLong(string source)
        {
            var converter = new StringToLongTypeConverter();
